...
class ProfilePageState extends State<ProfilePage> {
  ...
  void getInfo() async {
    ...
    var uri=new Uri.http("$serverIP:$serverPort", "/getQuestionsInfo");
    ...
    if(response.statusCode==200)
      {
        ...
        //_quesAsked= await response.stream.bytesToString();
      }
    setState(() {});
  }

  ///Initializes the profile pic
  ///
  /// Stores profile pic if it already exists
